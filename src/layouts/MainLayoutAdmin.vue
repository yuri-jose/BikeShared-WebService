    ...
    <q-header elevated class="text-white" style="background: #24292e" height-hint="61.59">
      <q-toolbar class="q-py-md q-gutter-xs row q-px-xs">
        <div class="q-ml-xs q-gutter-sm text-body2">
          <q-btn class="q-mr-sm col-2 col-sm-1 col-md-2 col-xs-1 col-lg-2 col-xl-1" round dense flat :ripple="false"
            icon="img:/img/noun-bike-1997666.svg" label="BikeShared" size="17px" color="orange" no-caps />
        </div>
        ...
        <div class="GL__toolbar-link q-ml-xs q-gutter-sm text-body2 text-weight-bold row items-center no-wrap">
          ...
          <a v-if="$q.screen.md || $q.screen.lg" class="text-white col-2 col-sm-2 col-md-2 col-xs-2 col-lg-2 col-xl-2"
        ...
        <div class="q-pl-sm q-gutter-sm row items-center no-wrap">
          <q-btn class="col-2 col-sm-2 col-md-2 col-xs-2 col-lg-2 col-xl-2" dense flat round size="sm"
            icon="notifications" />
