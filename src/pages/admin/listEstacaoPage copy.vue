...
//import { useQuasar } from 'quasar'; useRoute
...
export default defineComponent({
  setup() {
    ...
    //const urlsoap = 'https://apphom.correios.com.br/SigepMasterJPA/AtendeClienteService/AtendeCliente?wsd1';
    // const rows = ref([]);
    const rows = ref([
      {
        nome: 'UAN Station',
    ...
    /*
    const infoStation = async () => {
      soap.createCliet(urlsoap, (err, client) => {
        if (err)
          console.log(err);
        else {
          console.log('ok..');
