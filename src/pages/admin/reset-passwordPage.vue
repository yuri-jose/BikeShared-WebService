<template>
  <q-page padding>
    <div class="column bg-white q-gutter-y-md items-center" :class="{
      'login-size': $q.screen.width > 599,
      'absolute-center': $q.screen.width > 599,
    }">

      <div class="full-width text-h7 text-center"><strong>Recomendamus-lhe uma senha forte <strong
            class="text-primary">BikeShared</strong>, informe o seu E-mail.</strong></div>
      <br><br>

      <q-form @submit.prevent="handleRestEmail" class="full-width q-mt-lg constrain-4">
        <q-input dense v-model="email" rounded outlined label="E-mail" lazy-rules
        ...
        <q-btn :to="{ name: 'reset-password' }" label="Cancelar"
          class="full-width q-my-md text-primary text-center text-h9" flat />
        <br />
